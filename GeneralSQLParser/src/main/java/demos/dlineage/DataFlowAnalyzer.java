...
import demos.dlineage.entity.xmls.DlineageEntity;
import demos.dlineage.entity.xmls.Source;
import demos.dlineage.entity.xmls.Target;
...
//		String sqls = "insert into tablea select name,age from  b;";
...
// */
		...
		DataFlowAnalyzer dlineage = new DataFlowAnalyzer( sqls,
				vendor,
				true );
