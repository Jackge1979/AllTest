 ...
 */
public class DtwaveLineageLogger implements ExecuteWithHookContext {

    private static final Logger LOG = LoggerFactory.getLogger(DtwaveLineageLogger.class);
...
//        Index index =  LineageCtx.Index;
        ...
        if (ss != null && OPERATION_NAMES.contains(plan.getOperationName())
            ...
            try {
                ...
                List<Edge> edges = getEdges(plan, null);
...
//        return edges;
    ...
    private String getQueryHash(String queryStr) {
        ...
        hasher.putString(queryStr, Charset.forName("UTF-8"));
